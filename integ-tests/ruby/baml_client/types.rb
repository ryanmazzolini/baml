...
module BamlClient
  ...
  JsonEntry = T.type_alias{ T.any(SimpleTag, T.anything) }
  ...
  JsonValue = T.type_alias{ T.any(Integer, String, T::Boolean, Float, T.anything, T.anything) }
  ...
  RecAliasOne = T.type_alias{ T.anything }


  RecAliasThree = T.type_alias{ T::Array[T.anything] }


  RecAliasTwo = T.type_alias{ T.anything }
